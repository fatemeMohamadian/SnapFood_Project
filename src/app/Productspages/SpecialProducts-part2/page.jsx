...
export default function Specialpro() {
    const specialpro = useFetchpro('https://66c59ca1134eb8f43494e201.mockapi.io/specialfood')
    return (
        <>
            <div className='w-[90%] my-[10px] flex lg:justify-between items-center'>
                <h2 className='font-title2 w-[50%] font-semibold text-xl text-slate-700'>مزه های خاص</h2>
                <span className='flex lg:w-[30%] w-[50%] justify-end items-center'>
                    <Link className='flex justify-center *:text-green-600 font-bold items-center' href='Productspages/Allproducts/specialpro'>
            ...
            <div className='w-[90%] hidden *:my-[20px] md:flex justify-evenly items-center flex-wrap'>
                <Swiper
                    ...
                    spaceBetween={25}
                >
                    {specialpro && specialpro.map((val, i) => {
                        return (
                            <>
                                <SwiperSlide key={val.id} virtualIndex={i}>
                                    <div className='flex border-[1px] cursor-pointer border-slate-100 rounded-lg justify-center shadow-xl items-center flex-wrap'>
                                        <Link className='w-full' href='Productspages/Allproducts/specialpro'>
