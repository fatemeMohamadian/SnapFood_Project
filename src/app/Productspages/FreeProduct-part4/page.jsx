...
export default function Freepro() {
    const freepro = useFetchpro('https://66c5adb1134eb8f43495278f.mockapi.io/freeSend')
    return (
        <>
            <div className='w-[90%] my-[10px] flex lg:justify-between items-center'>
                <h2 className='font-title2 w-[50%] font-semibold text-xl text-slate-700'>ارسال رایگان</h2>
                <span className='flex lg:w-[30%] w-[50%] justify-end items-center'>
                    <Link className='flex justify-center *:text-green-600 font-bold items-center' href='Productspages/Allproducts/freepro'>
                        ...
                        return (
                            <>
                                <SwiperSlide key={val.id} virtualIndex={i}>
                                    ...
                                    <Link className='w-full' href='Productspages/Allproducts/freepro'>
